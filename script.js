...
document.querySelector('audio').volume = 0.1; // Ajusta el volumen (0 es silencio, 1 es el máximo)
...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'GRACIAS POR DEJARME ALEGRAR MAS TU VIDA MARIANA <3';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = '¡COMO QUE N0! ¿Estás segura?';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = 'a ok, andale, rechazame otra vez';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si porfaaaaaa';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'a no?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'tiste :c ';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'tiste x2';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'muy tiste :"c|';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'hagance a un lado qme wa suicidar';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'esta bien, yo no ruego';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'MENTIRIS, POR FAVOR DI SÍ';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'ES UNA ORDEN, ¿CHi?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'Hiciste llorar a la pulga';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
                ...
                document.getElementById('happyGifContainer').style.display = 'none';
                // Vuelve al estado 0
                window.location.href = 'https://www.youtube.com/watch?v=pyi0ZfuIIvo'; // Cambia VIDEO_ID por el ID del video que desees
                break;
